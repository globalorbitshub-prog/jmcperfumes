  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
      <aside className="lg:col-span-1 space-y-6">
        <form className="space-y-4 sticky top-20">
          <input
            type="text"
            name="search"
          ...
          <div>
            ...
            <select name="category" defaultValue={searchParams.category || ""} className="w-full border border-border rounded px-3 py-2 text-sm">
          ...
          <div className="grid grid-cols-2 gap-2">
            <input type="number" name="minPrice" defaultValue={searchParams.minPrice} placeholder="Min €" className="border border-border rounded px-3 py-2 text-sm" />
            <input type="number" name="maxPrice" defaultValue={searchParams.maxPrice} placeholder="Max €" className="border border-border rounded px-3 py-2 text-sm" />
          </div>

          <div>
            <div className="text-sm font-medium text-primary mb-2">Ordenar por</div>
            <select name="sort" defaultValue={searchParams.sort || ""} className="w-full border border-border rounded px-3 py-2 text-sm">
          ...
          <button className="w-full bg-secondary hover:bg-accent transition text-white rounded py-2 text-sm">
            Aplicar filtros
          </button>
